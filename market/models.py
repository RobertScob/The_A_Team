...
class Item(models.Model):
    ...
    seller = models.ForeignKey(settings.AUTH_USER_MODE, on_delete=models.CASCADE, related_name="items_listed")
...
class Transaction(models.Model):
    ...
    buyer = models.ForeignKey(settings.AUTH_USER_MODE, on_delete=models.CASCADE, related_name='transactions')
